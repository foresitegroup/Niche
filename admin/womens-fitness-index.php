<?php
include "login.php";
$PageTitle = "Women's Fitness Sign-Up";
include "header.php";
?>
...
<table width="100%" cellspacing="0" cellpadding="0">
  <tr>
    <td>
      <form action="womens-fitness-export.php" method="POST">
    ...
    <td style="text-align: center;">
      <form action="womens-fitness-db.php" method="POST">
...
<?php
$result = mysql_query("SELECT * FROM womensfitness ORDER BY lastname ASC");
...
while ($row = mysql_fetch_array($result)) {
  ...
  $Message .= "<br>";
  if (!empty($row['numberstudents'])) $Message .= "Total number of students: " . $row['numberstudents'] . "<br>";
?>
  <tr<?php echo $bg; ?>>
    ...
    <td style="text-align: center; height: 24px; line-height: 24px;">
      <a href="womens-fitness-db.php?a=delete&id=<?php echo $row['id']; ?>" onClick="return(confirm('Are you sure you want to delete this record?'));"><img src="images/delete.png" alt="Delete" title="Delete" style="vertical-align: middle;"></a>
    </td>
    <td style="text-align: center;">
      <a href="womens-fitness-db.php?a=exported&id=<?php echo $row['id']; ?>">
      <?php
